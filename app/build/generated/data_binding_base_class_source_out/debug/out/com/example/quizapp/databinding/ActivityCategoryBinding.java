...
public final class ActivityCategoryBinding implements ViewBinding {
  ...
  private ActivityCategoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull RecyclerView recyclerViewCategories,
      @NonNull MaterialToolbar toolbar, @NonNull TextView tvCategoryHeader) {
  ...
  public static ActivityCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCategoryBinding((ConstraintLayout) rootView, appBarLayout,
          recyclerViewCategories, toolbar, tvCategoryHeader);
    }
